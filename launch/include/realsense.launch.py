...
configurable_parameters = [{'name': 'camera_name',                  'default': 'rs_camera', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'rs_camera', 'description': 'namespace for camera'},
