...
"""
"""
FIXME: If using the launch file without passing additional arguments, please
change these two declaration of default map/path file name based on your
actual setup
...
def generate_launch_description():
    ...
    rviz_interactive_node = Node(
        ...
        output="screen",
        name="rviz2",
        # the arguments basocally append "-d ..." to "ros2 run rviz2 rviz2" cmd
        arguments=[
            "-d"
            + os.path.join(
                get_package_share_directory("rallycar"),
