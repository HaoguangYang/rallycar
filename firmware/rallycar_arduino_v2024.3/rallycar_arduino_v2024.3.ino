#include "hdlc.h"
#include "arduino_sensor_network_node.h"
...
class MyNode : public sensor_network::Node<HdlcBase> {
using ImuRaw = rallycar_msgs__msg::ImuRaw;
using Float32 = std_msgs__msg::Float32;
public:
    MyNode(ArduinoHardware* hw, HdlcBase* fr) :
      Node<HdlcBase>(hw, fr),
      imu_pub(this),
      accel_brake_sub(&MyNode::accelBrakeCb, this),
      steer_sub(&MyNode::steerCb, this),
      accel_watchdog(this->get_clock(), 2000000UL, &MyNode::acceleratorCmdWatchdog, this)
    {
...
protected:
    ...
    sensor_network::Publisher<ImuRaw, MyNode> imu_pub;
    sensor_network::Subscription<Float32, MyNode> accel_brake_sub, steer_sub;
    sensor_network::WallTimer<ClockT, MyNode> accel_watchdog;
};
